    ...
    <div>
      <div>
        ...
        <div className='Uxhero-container'>
          <div>
            <img className='video-frame' src={process.env.PUBLIC_URL + "/images/videoframe.png"} alt='video' />
          </div>
          <div className="Uxhero-right-container">
            <h2>User Experience course for beginners</h2>
            <p className="Uxhero-text">Welcome to User Experience (UX) Design for Beginners!</p>
            <div className="Uxhero-rating-button-container">
              ...
              <p className='video-icon-text'>
                <FontAwesomeIcon className="video-icon" icon={faVideo} /> 1hr 39min of on-demand video
              </p>
              </div>
            </div>
            <p className='Uxhero-creator'>Created by <span>Chidubem</span></p>
            <p>
